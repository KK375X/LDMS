...
!function (e) {
    ...
    v.isLeapYear = function (e) {
        ...
        var t = this, a = t.config, n = "yyyy|y|MM|M|dd|d|HH|H|mm|m|ss|s", l = "static" === a.position, i = {
            year: "yyyy",
            month: "yyyy-MM",
            date: "yyyy-MM-dd",
            time: "HH:mm:ss",
...
!function (e, t) {
    ...
    var Ze = / jQuery\d+="(?:null|\d+)"/g, et = new RegExp("<(?:" + ze + ")[\\s/>]", "i"),
            ...
            ot = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, at = p(re), st = at.appendChild(re.createElement("div"));
    pe.extend({
    ...
    pe.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, a, s, u, l, c, f, d = pe.ajaxSetup({}, n), p = d.context || d,
                    ...
                    m = pe.Callbacks("once memory"), y = d.statusCode || {}, v = {}, x = {}, b = 0, w = "canceled",
                    T = {
...
layui.define("jquery", function (e) {
    ...
    var i = layui.jquery, t = {
            ...
            u = "layui-slider-wrap-btn", d = "layui-slider-tips", v = "layui-slider-input",
            c = "layui-slider-input-txt", p = "layui-slider-input-btn", m = "layui-slider-hover", f = function (e) {
                var a = this;
...
layui.define("jquery", function (e) {
    ...
    var i = layui.$, n = (layui.hint(), layui.device(), {
            ...
            r = "layui-carousel-right", d = "layui-carousel-prev", s = "layui-carousel-next",
